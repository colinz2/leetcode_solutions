...
### cpp [🔗](remove-duplicates-from-sorted-array-ii.cpp) 
```cpp
class Solution {
public:
...
- [删除有序数组中的重复项](../remove-duplicates-from-sorted-array/README.md)  [Easy] 


## Links

- [Prev](../word-search/README.md) 
- [Next](../remove-duplicates-from-sorted-list-ii/README.md) 
