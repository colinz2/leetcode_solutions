...
### cpp [🔗](er-jin-zhi-zhong-1de-ge-shu-lcof.cpp) 
```cpp
class Solution {
public:
...
- [Prev](../he-bing-liang-ge-pai-xu-de-lian-biao-lcof/README.md) 
- [Next](../lian-biao-zhong-dao-shu-di-kge-jie-dian-lcof/README.md) 
